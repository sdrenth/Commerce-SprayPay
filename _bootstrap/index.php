...
if (!createObject('modNamespace',array(
    'name' => 'commerce_spraypay',
    'path' => $componentPath.'/core/components/commerce_spraypay/',
    'assets_path' => $componentPath.'/assets/components/commerce_spraypay/',
),'name', false)) {
    echo "Error creating namespace commerce_spraypay.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_spraypay.core_path',
    'value' => $componentPath.'/core/components/commerce_spraypay/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_spraypay',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_spraypay.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_spraypay.assets_path',
    'value' => $componentPath.'/assets/components/commerce_spraypay/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_spraypay',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_spraypay.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_spraypay/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_spraypay.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_spraypay',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_spraypay.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_spraypay.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_spraypay/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_spraypay/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'Sdrenth\\Commerce\\SprayPay\\Modules\\', $modulePath);
